...
class Money(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image_coin = pygame.image.load("./resources/coin.png")
        self.image_coin = pygame.transform.scale(self.image_coin, (50, 50))
        self.image_bag = pygame.image.load("./resources/bag.png")
        self.image_bag = pygame.transform.scale(self.image_bag, (60, 60))
        self.image_cash = pygame.image.load("./resources/cash.png")
        self.image_cash = pygame.transform.scale(self.image_cash, (50, 50)) 
   
        self.list = [self.image_coin, self.image_bag, self.image_cash]
        self.image = random.choice(self.list)
        self.rect = self.image.get_rect()
...
while not done:
    ...
    if pygame.sprite.spritecollideany(P1, money):
        collided_money = pygame.sprite.spritecollideany(P1, money)
        if collided_money.image == MONEY.image_coin:
            coins_score += 1
        elif collided_money.image == MONEY.image_cash:
            coins_score += 2
        elif collided_money.image == MONEY.image_bag:
            coins_score += 3
        collided_money.appear() 
